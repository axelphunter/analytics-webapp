...
((base, document) => {
  const componentName = 'pie-globe-3d';
  let globeCanvas;
  let width;
  let height;
  ...
  proto.createdCallback = function createdCallback() {
    const self = this;
    width = self.parentElement.clientWidth;
    height = self.parentElement.clientHeight;
    globeCanvas = helpers.createEl(self, 'canvas', {
      width,
      height,
      id: 'rotatingGlobe'
    });
  ...
  proto.render = function createdCallback() {
